...
import com.devsuperior.desdeliver.dto.ProductDTO;
import com.devsuperior.desdeliver.entities.Order;
import com.devsuperior.desdeliver.entities.OrderStatus;
import com.devsuperior.desdeliver.entities.Product;
import com.devsuperior.desdeliver.repositories.OrderRepository;
import com.devsuperior.desdeliver.repositories.ProductRepository;
...
public class OrderService {
	...
	public OrderDTO insert(OrderDTO dto){
		Order order = new Order(null, 
				dto.getAddress(), dto.getLatitude(), dto.getLongitude(),
